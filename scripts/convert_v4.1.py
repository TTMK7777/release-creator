...
if __name__ == "__main__":
    ...
    # Module2_Data_Dynamic.bas (完全動的版)
    input_path2 = os.path.join(utf8_dir, "Module2_Data_Dynamic.bas")
    output_path2 = os.path.join(vba_dir, "Module2_Data_Dynamic_SJIS.bas")

    if os.path.exists(input_path2):
        print(f"変換中: Module2_Data_Dynamic.bas")
