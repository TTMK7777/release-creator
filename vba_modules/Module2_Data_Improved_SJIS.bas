...
Public Function TransferRankingData( _
    ...
    For Each ws In targetWb.Worksheets
        Module1_Main.LogMessage "    - " & ws.Name
    Next ws
    ...
    Module1_Main.LogMessage "  [OK] ランキングデータ転記完了 (" & rankingCount & "件)"
    ...
    Module1_Main.LogMessage "  [OK] 注釈生成完了"
...
Public Function ValidateSourceData(sourceFilePath As String) As Boolean
    ...
    Module1_Main.LogMessage "[OK] 元データの検証が完了しました"
