...
if search_keyword:
    ...
    category_options = {
        ...
        "金融・投資": [r for r in all_rankings if any(k in r for k in ["証券", "NISA", "iDeCo", "銀行", "ローン", "カード", "FX", "暗号", "ロボ"])],
        ...
        "通信": [r for r in all_rankings if any(k in r for k in ["携帯", "SIM", "スマホ", "プロバイダ"])],
        ...
        "トラベル・美容・その他": [r for r in all_rankings if any(k in r for k in ["旅行", "ツアー", "エステ", "サロン", "ウエディング", "結婚", "家電", "ドラッグ", "映画", "カラオケ", "テーマパーク", "フィットネス", "ジム"])],
    }
